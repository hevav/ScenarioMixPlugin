package net.elytrium.elytramix.scenarios.gameplay.blockshuffle;
...
public class BlockShuffle extends Scenario {
    public BlockShuffle() {
        super("BlockShuffle", "block_shuffle", "IRON_BOOTS", "scenario","Игроки должны за определенное", "время встать на блок, имя", "которого они увидят на", "экране.");
        addConfig(materials);
    }
